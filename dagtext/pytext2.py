...
#=======================================================================
#
#                 Textnode Base Class And Editor
#
#=======================================================================
...
class Toolbar(tk.Frame):
    def __init__(self,parent,*args,**kwargs):
        tk.Frame.__init__(self, parent, *args, **kwargs)
        self.leftarrowimg = ImageTk.PhotoImage(Image.open("leftarrow.gif"))
        self.rightarrowimg = ImageTk.PhotoImage(Image.open("rightarrow.gif"))
        self.backButton = tk.Button(self,image=self.leftarrowimg)
        self.forwardButton = tk.Button(self,image=self.rightarrowimg)
        self.backButton.pack(side=tk.LEFT)
        self.forwardButton.pack(side=tk.LEFT)
...
#=======================================================================
#
#                        Status Bar At Bottom Of Main Page
#
#=======================================================================
...
class Main(tk.Frame):
    ...
    def __init__(self,parent,*args,**kwargs):
        tk.Frame.__init__(self, parent, *args, **kwargs)
        self.canvas = MyCanvas(self,bg="cyan")
